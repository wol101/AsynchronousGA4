...
# convert 'icon_design_4697x4697.png' -bordercolor white -border 0 \( -clone 0 -resize 16x16 \) \( -clone 0 -resize 24x24 \) \( -clone 0 -resize 32x32 \) \( -clone 0 -resize 40x40 \) \( -clone 0 -resize 48x48 \) \( -clone 0 -resize 64x64 \) \( -clone 0 -resize 256x256 \) -delete 0 -alpha off -colors 256 icon_256x256.ico
...
convert resized_icons/icon128x128.png resized_icons/icon16x16.png resized_icons/icon192x192.png resized_icons/icon24x24.png resized_icons/icon256x256.png resized_icons/icon32x32.png resized_icons/icon40x40.png resized_icons/icon48x48.png resized_icons/icon64x64.png resized_icons/icon96x96.png icon_design.ico
...
cp resized_icons/icon256x256.png icon_design.png
